...
//OBSERVER
 ...
 //       collisionBehavior.translatesReferenceBoundsIntoBoundary = true
       ...
       collisionBehavior.addBoundaryWithIdentifier("ceiling", fromPoint: CGPointZero, toPoint: CGPointMake(SCREEN_WIDTH,0))
        ...
        collisionBehavior.addBoundaryWithIdentifier("lava", fromPoint: CGPointMake(0,SCREEN_HEIGHT - 30), toPoint: CGPointMake(SCREEN_WIDTH, SCREEN_HEIGHT))
...
//        GameData.mainData().currentGame?["livesLost"] = ll
    ...
    func createBricks() {
        ...
        var width = (SCREEN_WIDTH - CGFloat(gap * CGFloat(grid.0 + 1))) / CGFloat(grid.0)
